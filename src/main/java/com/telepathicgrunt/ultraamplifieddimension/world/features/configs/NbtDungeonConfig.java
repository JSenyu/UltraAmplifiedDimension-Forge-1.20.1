...
public class NbtDungeonConfig implements FeatureConfiguration {
    ...
    public static final Codec<NbtDungeonConfig> CODEC = RecordCodecBuilder.<NbtDungeonConfig>create(configInstance -> configInstance.group(
            ...
            Codec.mapPair(
                    ...
                    .forGetter(nbtFeatureConfig -> nbtFeatureConfig.spawnerResourcelocationsAndWeights),
            ...
            ResourceLocation.CODEC.fieldOf("post_processors")
                    .orElse(ResourceLocation.fromNamespaceAndPath("minecraft", "empty"))
                    .forGetter(nbtDungeonConfig -> nbtDungeonConfig.postProcessor),
            Codec.mapPair(ResourceLocation.CODEC.fieldOf("resourcelocation"), Codec.intRange(1, Integer.MAX_VALUE).fieldOf("weight"))
                    .codec()
                    .listOf()
                    .fieldOf("dungeon_nbt_entries")
            ...
            .comapFlatMap(nbtDungeonConfig -> nbtDungeonConfig.maxAirSpace <= nbtDungeonConfig.minAirSpace
                    ? DataResult.error(() -> "min_air_space has to be smaller than max_air_space")
                    : DataResult.success(nbtDungeonConfig), Function.identity());
